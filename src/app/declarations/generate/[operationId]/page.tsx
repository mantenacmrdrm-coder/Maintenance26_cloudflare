...
// 1. Mettez à jour le type : params doit être défini comme une Promise
export default async function GenerateDeclarationPage({ 
  params 
}: { 
  params: Promise<{ operationId: string }> 
}) {
  // 2. Maintenant l'await correspond correctement au type
